import { DefineAppConfigOptions } from '#/config'
import { HandlerSettingEnum, NavBarModeEnum } from '@/enums'
import { useAppConfig as appConfigStore, initAppConfigStore } from '@/store/modules/appConfig'
...
export const useAppConfig = () => {
  ...
  const { openSettingDrawer, sidebar, menu, isMixSidebar, isSidebar } = appConfigOptions
  ...
  function preDealConfig(configs: DeepPartial<DefineAppConfigOptions>) {
    if (configs.navBarMode && configs.navBarMode === NavBarModeEnum.MIX_SIDEBAR) {
